    ...
    return (
        ...
        <div className="carousel-inner ">
            ...
            <div className="d-flex justify-content-center align-items-center">
                <Image src="https://m.media-amazon.com/images/I/71n2eiYGmHL._AC_SL1500_.jpg"  height="500" width="500" alt="..."/>
            </div>
            ...
            <div className="d-flex justify-content-center align-items-center">
                <Image src="https://m.media-amazon.com/images/I/51Tp8BrXykL._AC_SL1180_.jpg"  height="500" width="500" alt="..."/>
            </div>
            <div className="carousel-caption d-none d-md-block carousel-content-container">
            ...
            <div className="carousel-item">
            <div className="d-flex justify-content-center align-items-center">
                <Image src="https://m.media-amazon.com/images/I/51hdIfB7OJS._AC_SL1500_.jpg"  height="500" width="307" alt="..."/>
            </div>
            <div className="carousel-caption d-none d-md-block carousel-content-container">
